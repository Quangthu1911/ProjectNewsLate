...
//			request.setAttribute("users",list);
	...
	public String saveup(HttpServletRequest request,BindingResult bindingResult,
			@RequestParam("image1") MultipartFile photo) throws NumberFormatException, IOException
	{
		String id=request.getParameter("id");
